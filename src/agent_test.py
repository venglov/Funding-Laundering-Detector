...
class TestFLDAgent:
    ...
    def test_returns_critical_finding_if_the_amount_is_big_erc20_new_address_FLD_FUNDING(self):
        tx_event = create_transaction_event({
            'transaction': {
                'from': BINANCE_ADDRESS,
                'to': NEW_ADDRESS,
            ...
            'logs': [
                transfer_event(BINANCE_ADDRESS, NEW_ADDRESS, 1000000000,
    ...
    def test_returns_low_finding_if_the_amount_is_low_erc20_old_address_FLD_FUNDING(self):
        tx_event = create_transaction_event({
            ...
            'logs': [
                transfer_event(BINANCE_ADDRESS, OLD_ADDRESS, 1000000000,
                               "0xdAC17F958D2ee523a2206206994597C13D831ec7")]})
    ...
    def test_returns_low_finding_if_the_amount_is_low_erc20_old_address_FLD_Laundering(self):
        tx_event = create_transaction_event({
            ...
            'logs': [
                transfer_event(OLD_ADDRESS, BINANCE_ADDRESS, 1000000000,
                               "0xdAC17F958D2ee523a2206206994597C13D831ec7")]})
    ...
    def test_returns_critical_finding_if_the_amount_is_critical_erc20_old_address_FLD_Laundering(self):
        tx_event = create_transaction_event({
            ...
            'logs': [
                transfer_event(OLD_ADDRESS, BINANCE_ADDRESS, 5000000000000,
                               "0xdAC17F958D2ee523a2206206994597C13D831ec7")]})
